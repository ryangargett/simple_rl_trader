...
class EricTrader(SimpleTrader):
    ...
    def _get_reward_eric_0(self):
        ...
        #penalty for holding funds (dollar value)
        funds_penalty = - (self.curr_funds * 0.05)

        #reward for making profit from initial funds (dollar value)
        ...
        #setting a minimum % it ahs to return (3%)
        ...
        reward = funds_penalty + profit_reward + portfolio_reward + return_reward + portfolio_return
