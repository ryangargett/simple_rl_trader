...
class EricTrader(SimpleTrader):
    ...
    def _get_reward_eric_0(self):
        ...
        if  percent_portfolio_return > 3:                       #small reward for performing good
            ...
            percent_portfolio_reward = -(15 * (3 -  percent_portfolio_return))            
        ...
        reward = funds_penalty + dollar_profit_reward + dollar_portfolio_reward + percent_portfolio_reward + percent_prev_portfolio_return 
        ...
        print(colored(f'percent portfolio return {percent_portfolio_return}', 'magenta'))
        print(colored(f'percent prev portfolio return {percent_prev_portfolio_return}', 'magenta'))
