...
class EricTrader(SimpleTrader):
    ...
    def _get_reward_eric_0(self):
        ...
        #setting a minimum performance return it has to make (4%) will get reward for every percent above 4% and penalise if it doesnt
        return_reward = (self.portfolio_value - self.previous_portfolio) - 1
