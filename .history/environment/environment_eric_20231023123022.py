...
class EricTrader(SimpleTrader):
    ...
    def _get_reward_eric_0(self):
        ...
        if return_per > 0.03:
            return_reward = 10 * (return_per - 0.03) #small reward for performing good
        elif return_per < 0.03:
            return_reward = -(15 * (0.03 - return_per)            #larger penalisation for bad performance
